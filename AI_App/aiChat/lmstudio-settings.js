...
(function (root) {
  ...
  function settingsMarkup() {
    return [
      ...
      '    <input id="settings-lmstudio-base-url-secondary" type="url" spellcheck="false" placeholder="https://example.com/v1" onclick="document.querySelector(\'[name=&quot;settings-lmstudio-base-url-slot&quot;][value=&quot;secondary&quot;]\').checked=true" class="w-full px-2 py-1.5 border rounded bg-white dark:bg-slate-800 text-slate-900 dark:text-slate-100 border-slate-200 dark:border-slate-600">',
      '    <p class="text-[10px] leading-relaxed text-slate-500 dark:text-slate-400">선택한 URL을 모델 확인과 AI 요청에 사용합니다. 두 주소는 함께 저장됩니다.</p>',
      '  </div>',
