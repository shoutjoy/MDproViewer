(function (global) {
  ...
  var SHELL_VERSION = '20260810-scholar-storage-indb-fallback-1';
  var SHELL_TEMPLATE_VERSION = '20260810-scholar-storage-indb-fallback-1';
  var SCHOLAR_REF_VERSION = '20260810-scholar-storage-indb-fallback-1';
  ...
  function ensureStorageArtifactButtons() {
    var explorerButton = q('scholar-search-storage-explorer-btn');
    ...
    if (!explorerButton && explorerActions) {
      ...
      explorerButton.id = 'scholar-search-storage-explorer-btn';
      explorerButton.onclick = openScholarStorageExplorer;
    }
    if (explorerButton && explorerActions) {
      ...
      explorerButton.textContent = '▣ STORAGE 탐색기 열기';
    ...
    if (!inDbExplorerButton && explorerActions) {
      ...
      inDbExplorerButton.textContent = 'inDB 전용 탐색기';
  ...
  function openScholarStorageExplorer(filter) {
    state.crossrefStorageFilter = filter === 'indb' ? 'indb' : 'all';
    var modal = q('scholar-crossref-results-modal');
    var input = q('scholar-crossref-results-md');
    if (!modal || !input) {
  ...
  function openScholarSqliteExplorer() {
    return openScholarStorageExplorer();
  }
